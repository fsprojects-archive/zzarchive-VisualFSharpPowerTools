...
-----------------------
When highlight references are enabled, you can go to next and previous highlighted references using default key bindings: `Ctrl Shift + Arrow Down` and `Ctrl Shift + Arrow Up` respectively. 
